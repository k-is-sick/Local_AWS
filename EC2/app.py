...
<div class="topnav">
  ...
  <span>Services</span>
  <span>&#128269;</span>
  <span style="margin-left:auto; color:#ccc; font-size:12px;">MiniStack Local Console</span>
</div>
<div class="subnav">
...
def launch():
    ...
    c = client.containers.run(image, detach=True, tty=True, stdin_open=True,  command="sleep infinity",  name=f"ec2-{iid}",  network="ministack")
