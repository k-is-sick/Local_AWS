...
DB_HOST = os.environ.get("DB_HOST", "iamdb")
DB_NAME = os.environ.get("DB_NAME", "localawsiam")
DB_USER = os.environ.get("DB_USER", "localawsiam")
DB_PASSWORD = os.environ.get("DB_PASSWORD", "localawsiam")
